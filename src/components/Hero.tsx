...
export default function Hero() {
    return (
        <section className="relative w-full min-h-[35vh] md:min-h-[55vh] flex flex-col items-center justify-end pb-12 px-4 pt-20 md:pb-24 md:px-8 md:pt-28 overflow-hidden">
